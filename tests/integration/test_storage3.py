...
def test_create_multipart_upload():
    ...
    assert mp_info == {'dst_info': {'url': 's3://localhost:7000/test_bucket/copied_file', 's3_loc': 'localhost:7000', 'bucket_name': 'test_bucket', 'key_name': 'copied_file'}, 'src_info': {'url': 's3://localhost:7000/test_bucket/original_file', 's3_loc': 'localhost:7000', 'bucket_name': 'test_bucket', 'key_name': 'original_file'}, 'mp_chunk_size': 1073741824, 'download_chunk_size': 16777216, 'cur_size': 0, 'chunk_index': 1, 'total_size': 0, 'manifest': {'Parts': []},}
...
def test_copy_multipart_file():
    ...
    assert res == {'md5_sum': 'bc0354f0646794a755a4276435ec5a6c', 'sha256_sum': 'c97d1f1ab2ae91dbe05ad8e20bc58fc6f3af28e98d98ca8dbeee31a9d32e1e5b', 'bytes_transferred': 40000000}
